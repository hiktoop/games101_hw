...
public:
    ...
    Vector3f e1, e2;     // 2 edges v1-v0, v2-v0; (this is a good extension)
...
{
public:
    // load the obj file as a mesh triangle
    ...
    // mesh triangle use rayTriangleIntersect
